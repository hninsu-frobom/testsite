...
<div class="container">
  <div class="row">
    <div class="col-xs-12 col-sm-6 offset-sm-3 col-md-6 offset-md-3">    
      <div class="my-3">
        <p class="my-3 text-center">All Todo List</p>
        @if (count($todos) > 0)
          ...
          @foreach ($todos as $todo)
               ...
               <li class="list-group-item">
                 ...
                 <div class="collapse" id="collapse-id-{{ $todo->id }}"> <!-- collapse ( main point )-->
                   <div class="card card-body">
                     <div class="todo-description">{{ $todo->description }}</div>
                     <hr>
                     <p>Status: {{ $todo->status }}</p>
                     <p title="{{ $todo->created_at }}">Created: {{ $todo->created_at }}</p>
                    </div>
                 </div>
              </li>
